+++
title = "Gheymeh Bademjan: The Stew Where Eggplant Earns Its Keep"
date = 2026-05-31
description = "A Persian split pea stew where slow-cooked diced meat meets golden-fried eggplant — comfort food with real nutritional depth"
...
ingredient_count = 14
ingredients = [
  "1½ cups yellow split peas (lapeh), rinsed and soaked",
  "2 medium onions, finely diced",
  "300g beef or stewing meat, cut into bite-sized pieces",
  "2 medium eggplants",
  "2 dried limes (limu omani), soaked in warm water",
  "1 can (400g) strained tomatoes (passata)",
  "2 tbsp tomato paste",
  "½ tsp ground saffron (brewed with ice water)",
  "1 tsp turmeric",
  "1 cinnamon stick",
  "3–4 cardamom pods, lightly crushed",
  "Olive oil",
  "Salt and black pepper",
  "2–3 medium potatoes (optional — for tahdig or fried garnish)"
]
+++
